...
/*
 * ============================================================
 * MOCK INTERVIEW PREFILL KEY
 * ============================================================
 *
 * Used to tell MockInterviewView which preparation basis
 * the user selected here.
 *
 * Possible values:
 *   self_based
 *   role_based
...
const MOCK_PREPARATION_MODE_KEY =
  'interviewai_mock_preparation_mode';
...
function getStoredQuestionSets(
  ...
  try {
    ...
    console.warn(
      'Failed to load stored question sets:',
      error
    );
  }
...
function saveStoredQuestionSet(
  ...
  try {
    ...
    /*
     * Never save question sets without a user.
     */
    if (!storageKey) {
      return;
    }
    ...
    console.warn(
      'Failed to save stored question set:',
      error
    );
  }
}
...
export const PreparationSetupView: React.FC =
  () => {
    ...
    /*
     * Used only for showing the loading state while
     * generating the question bank.
     *
     * Launch Mock Interview no longer generates questions here.
     */
    const [
    ...
    /*
     * ========================================================
     * RESET USER-SCOPED JD STATE WHEN USER CHANGES
     * ========================================================
     */
     ...
     *   Questions Page
     *
     * It is no longer used by "Launch Mock Interview".
     * ========================================================
     */
    ...
    const handleGenerateQuestionBank =
      async () => {
        setGenerationError(null);
        setIsStartingMockDirectly(false);
     ...
     *
     * We only transfer the preparation context to
     * MockInterviewView.
     *
     * Actual interview generation/session creation happens
     * after the user configures the mock interview there.
     * ========================================================
     */
    ...
    const handleLaunchMockInterview =
      () => {
        ...
        /*
         * Job-specific preparation requires a JD.
         */
        if (
          prepMode ===
          'role_based' &&
        ...
        /*
         * Save the preparation basis so MockInterviewView
         * can use the correct context.
         */
        localStorage.setItem(
          MOCK_PREPARATION_MODE_KEY,
          prepMode
        );

        /*
         * Keep the currently selected JD synchronized.
         */
        if (
          prepMode ===
            'role_based' &&
        ...
        /*
         * Pass the basis through the URL as well.
         * This makes the navigation state explicit.
         */
        const params =
          new URLSearchParams();
        ...
        /*
         * This is now the ONLY action of the button.
         */
        navigate(
          `/app/mock-interview?${params.toString()}`
        );
      };

    /*
     * ========================================================
     * OPEN PREVIOUS QUESTION SET
     * ========================================================
     */
    ...
    const handleOpenPreviousSet =
      async (
        ...
        try {
          ...
          /*
           * View Questions behaves exactly as before.
           */
          if (!startMock) {
            navigate(
              '/app/questions'
          ...
          /*
           * For a saved set's Practice Mock, preserve the
           * same UX principle: go to MockInterviewView first.
           *
           * Save the basis and existing JD.
           */
          localStorage.setItem(
            MOCK_PREPARATION_MODE_KEY,
            questionSet.mode
          ...
          /*
           * We intentionally do not create the session here.
           */
          navigate(
            `/app/mock-interview?${params.toString()}`
          );
